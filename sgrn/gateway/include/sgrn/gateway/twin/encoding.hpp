...
{
sgrn::Result<void, ::sgrn::scl::Error> encodeFieldAt(const ::sgrn::scl::DbField& t_field, const std::string& t_value_json, uint8_t* tp_ptr,
    size_t t_buffer_size, int t_depth = 0, s7codec::Endian t_e = s7codec::Endian::Big);
sgrn::Result<void, ::sgrn::scl::Error> encodeFieldRapidJson(const ::sgrn::scl::DbField& t_field, const rapidjson::Value& t_value,
    uint8_t* tp_ptr, size_t t_buffer_size, int t_depth = 0, s7codec::Endian t_e = s7codec::Endian::Big);
sgrn::Result<void, ::sgrn::scl::Error> encodeScalarValue(const ::sgrn::scl::DbField& t_field, const rapidjson::Value& t_value,
    uint8_t* tp_ptr, size_t t_buffer_size, s7codec::Endian t_e = s7codec::Endian::Big);
sgrn::Result<void, ::sgrn::scl::Error> encodeArrayValue(const ::sgrn::scl::DbField& t_field, const rapidjson::Value& t_value,
    uint8_t* tp_ptr, size_t t_buffer_size, int t_depth = 0, s7codec::Endian t_e = s7codec::Endian::Big);
...
sgrn::Result<void, ::sgrn::scl::Error> applyJsonPatchToFields(const std::vector<::sgrn::scl::DbField>& t_fields,
