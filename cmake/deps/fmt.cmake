...
if(SGRN_DEPS_ONLY)
    if(SGRN_CROSS_WIN64)
        ...
        # linux / arm64 deps: build and stage fmt from CPM (same path as win64).
        # This makes the build fully self-contained — the normal build picks up
        # libfmt.a from extern-config.cmake and no longer needs conda's fmt package.
        set(FMT_INSTALL ON  CACHE BOOL "" FORCE)
        set(FMT_TEST    OFF CACHE BOOL "" FORCE)
        set(FMT_DOC     OFF CACHE BOOL "" FORCE)
        set(FMT_MODULE  OFF CACHE BOOL "" FORCE)
        ...
        set(SGRN_FMT_FORCE_BUILD ON)
        message(STATUS "[SGRN/fmt] (deps) Building fmt from CPM — will stage libfmt.a")
    endif()
    return()
endif()
